  ...
  return (
    <Card
      ...
      width={{
        base: "100%",
        ...(collapsed
          ? { [desktopBreakpoint]: `100px` }
          : { md: SIDE_MENU_WIDTH.MD, lg: SIDE_MENU_WIDTH.LG }),
      }}
      height={{
        base: "auto",
        [desktopBreakpoint]: `calc(100vh - ${HEADER_HEIGHT} - ${1.5 * 2}rem)`,
      }}
    >
      <Box
        as="nav"
            ...
            >
              ...
              >
                ...
                <Text
                  fontWeight="normal"
                  color={
                    router.pathname === item.pathname ? "white" : undefined
                  }
