...
export const useLabelAssistantReplyTask = () =>
  useGenericTaskAPI<LabelAssistantReplyTask, LabelTaskReply>(
    TaskType.label_assistant_reply,
  );
export const useLabelInitialPromptTask = () =>
  useGenericTaskAPI<LabelInitialPromptTask, LabelTaskReply>(
    TaskType.label_initial_prompt,
  );
export const useLabelPrompterReplyTask = () =>
  useGenericTaskAPI<LabelPrompterReplyTask, LabelTaskReply>(
