...
export const useRankAssistantRepliesTask = () =>
  useGenericTaskAPI<RankAssistantRepliesTask, EvaluateTaskReply>(
    TaskType.rank_assistant_replies,
  );

export const useRankPrompterRepliesTask = () =>
  useGenericTaskAPI<RankPrompterRepliesTask, EvaluateTaskReply>(
    TaskType.rank_prompter_replies,
  );

export const useRankInitialPromptsTask = () =>
  useGenericTaskAPI<RankInitialPromptsTask, EvaluateTaskReply>(
