...
export const useCreateAssistantReply = () =>
  useGenericTaskAPI<CreateAssistantReplyTask, CreateTaskReply>(
    TaskType.assistant_reply,
  );
export const useCreatePrompterReply = () =>
  useGenericTaskAPI<CreatePrompterReplyTask, CreateTaskReply>(
    TaskType.prompter_reply,
  );
export const useCreateInitialPrompt = () =>
  useGenericTaskAPI<CreateInitialPromptTask, CreateTaskReply>(
    TaskType.initial_prompt,
  );
